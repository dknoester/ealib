...
namespace ealib {
    namespace mkv {
        ...
        LIBEA_ANALYSIS_TOOL(dominant_genetic_graph) {
            ...
            ealib::mkv::write_graphviz(title.str(), df, as_genetic_graph(P));
        }
        ...
        LIBEA_ANALYSIS_TOOL(dominant_reduced_graph) {
            ...
            ealib::mkv::write_graphviz(title.str(), df, as_reduced_graph(P));
        }
        ...
        LIBEA_ANALYSIS_TOOL(dominant_causal_graph) {
            ...
            ealib::mkv::write_graphviz(title.str(), df, as_causal_graph(P));
        }
