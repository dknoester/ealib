 ...
 */
#ifndef _EA_DIGITAL_EVOLUTION_ANCESTORS_MULTI_BIRTH_SELFREP_ANCESTOR_H_
#define _EA_DIGITAL_EVOLUTION_ANCESTORS_MULTI_BIRTH_SELFREP_ANCESTOR_H_
...
namespace ealib {
    /*! Generates a self-replicating ancestor.
     */
    struct multibirth_selfrep_ancestor {
