/* digital_evolution/ancestors/multi_birth_selfrep_nand_not_ancestor.h
 *
 ...
 */
#ifndef _EA_DIGITAL_EVOLUTION_ANCESTORS_MULTI_BIRTH_SELFREP_NAND_NOT_ANCESTOR_H_
#define _EA_DIGITAL_EVOLUTION_ANCESTORS_MULTI_BIRTH_SELFREP_NAND_NOT_ANCESTOR_H_
