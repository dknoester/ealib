...
namespace mkv {
    ...
    LIBEA_MD_DECL(MKV_DIM_N, "markov_network.dim.n", std::size_t);
    ...
    LIBEA_MD_DECL(GATE_INPUT_LIMIT, "markov_network.gate.input.limit", std::size_t);
    LIBEA_MD_DECL(GATE_INPUT_FLOOR, "markov_network.gate.input.floor", std::size_t);
    LIBEA_MD_DECL(GATE_OUTPUT_LIMIT, "markov_network.gate.output.limit", std::size_t);
    LIBEA_MD_DECL(GATE_OUTPUT_FLOOR, "markov_network.gate.output.floor", std::size_t);
    LIBEA_MD_DECL(GATE_HISTORY_FLOOR, "markov_network.gate.history.floor", std::size_t);
    LIBEA_MD_DECL(GATE_HISTORY_LIMIT, "markov_network.gate.history.limit", std::size_t);
    LIBEA_MD_DECL(GATE_WV_STEPS, "markov_network.gate.wv_steps", std::size_t);
